...
Arbol::Arbol(Tipo t)
{
	...
	//Tronco
	objetos.push_back(new Cylinder(_o, 0.8, 0.6, 4, 0.5, 0.5, 0.2));
	...
	case Arbol::Abeto: // 1 CONO
		objetos.push_back(new CopaSimple(CopaSimple::Abeto));
	...
	case Arbol::Roble: // 1 ESFERA
		objetos.push_back(new CopaSimple(CopaSimple::Roble));
